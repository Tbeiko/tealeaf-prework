...
def english_number number 
	...
	if (number < 0) || (number > 100)
		return 'Please enter a number between zero and one hundred'
	end

	num_string = "" # This is the string we'll return 

	# "left"  is how much of the number we still
	# 			  have to write out 
	# "write" is the part we are writting out
	# 				right now 
	...
	if write > 0 
		if write == 1
			...
			# Since we already took care of the digit in the 
	...
	if num_string == ""
		# The only way "num_string" could be empty is if 
		# "number" is 0.
		return "zero"
	end
